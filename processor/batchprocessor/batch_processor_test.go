...
func TestBatchProcessorSpansDelivered(t *testing.T) {
	t.Run(t.Name() + "Legacy", func(t *testing.T) { testBatchProcessorSpansDelivered(t, false) }) // Test legacy implementation
	t.Run(t.Name() + "Helper", func(t *testing.T) { testBatchProcessorSpansDelivered(t, true) }) // Test new implementation
}

func testBatchProcessorSpansDelivered(t *testing.T, useExporterHelper bool) {
	defer setFeatureGateForTest(t, useExporterHelper)()
...
func TestBatchProcessorSpansDeliveredEnforceBatchSize(t *testing.T) {
	t.Run(t.Name() + "Legacy", func(t *testing.T) { testBatchProcessorSpansDeliveredEnforceBatchSize(t, false) }) // Test legacy implementation
	t.Run(t.Name() + "Helper", func(t *testing.T) { testBatchProcessorSpansDeliveredEnforceBatchSize(t, true) })  // Test new implementation
}

func testBatchProcessorSpansDeliveredEnforceBatchSize(t *testing.T, useExporterHelper bool) {
	defer setFeatureGateForTest(t, useExporterHelper)()
